...
public class ejercicioge4 extends javax.swing.JInternalFrame {
    public ejercicioge4() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Figuras y formas geométricas 2");
        ...
        BtnEqui5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/hepta3.png"))); // NOI18N
        ...
        BtnEqui5.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/hepta1.png"))); // NOI18N
        BtnEqui5.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/img/hepta3.png"))); // NOI18N
        ...
        cbresultado1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trapecio", "Heptágono", "Hexagono", "Ovalo", "Decagono", "Octagono" }));
        ...
        cbresultado5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trapecio", "Heptágono", "Hexagono", "Ovalo", "Decagono", "Octagono" }));
        ...
        cbresultado6.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trapecio", "Heptágono", "Hexagono", "Ovalo", "Decagono", "Octagono", " " }));
        ...
        BtnEqui4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/octa1.png"))); // NOI18N
        ...
        BtnEqui4.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/octa2.png"))); // NOI18N
        BtnEqui4.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/img/octa2.png"))); // NOI18N
        ...
        BtnEqui3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/deca3.png"))); // NOI18N
        ...
        BtnEqui3.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/deca1.png"))); // NOI18N
        BtnEqui3.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/img/deca2.png"))); // NOI18N
        ...
        cbresultado2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trapecio", "Heptágono", "Hexagono", "Ovalo", "Decagono", "Octagono" }));
        ...
        BtnEqui6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ovalo3.png"))); // NOI18N
        ...
        BtnEqui6.setPressedIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ovalo1.png"))); // NOI18N
        BtnEqui6.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ovalo2.png"))); // NOI18N
        ...
        cbresultado3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trapecio", "Heptágono", "Hexagono", "Ovalo", "Decagono", "Octagono" }));
        ...
        cbresultado4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trapecio", "Heptágono", "Hexagono", "Ovalo", "Decagono", "Octagono" }));
    ...
    private void BtnEqui5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEqui5ActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(null,"Poligono delimitado por siete segmentos de recta o lados que se interceptan \n en siete puntos no alineados llamados vértices.\n La suma de los ángulos interiores es  siempre igual a 900º");
    ...
    private void BtnEquiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEquiActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(null," Polígono que tiene 4 lados, de ellos, dos son paralelos.\n" +
"\n" +
"Los cuatro ángulos son distintos de 90º. La suma de los 4 ángulos es 360 grados.");
    ...
    private void BtnEqui4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEqui4ActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(null,"Polígono delimitado por ocho segmentos de recta o lados que se \n interceptan en ocho puntos no alineados llamados vértices.\nLa suma de los ángulos interiores es  siempre igual a 1080º");
    ...
    private void btnverfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnverfActionPerformed
      String Trap="Trapecio",Hepta="Heptágono",Hex="Hexagono",Ovalo="Ovalo",Deca="Decagono",Octa="Octagono";
        ...
        //if (btnverf.hasFocus()){
            ...
            if(r1.equals(Trap)&& r2.equals(Hex)&& r3.equals(Deca)&& r4.equals(Hepta)&& r5.equals(Ovalo)&& r6.equals(Octa)){
            ...
            }else
            {
                ...
                if(r2.equals(Hex)==false){
                    lbluch2.setVisible(true);
                    btnSiguiente.setVisible(false);
                    //cbresultado2.setEditable(false);
                    // cbresultado2.setEnabled(false);
                    //lbluch2.setVisible(false);
                }else{
                    lblch2.setVisible(true);
                    lblp2.setVisible(true);
                ...
                if(r3.equals(Deca)==false){
                    lbluch3.setVisible(true);
                    btnSiguiente.setVisible(false);
                    //cbresultado3.setEditable(false);
                    //cbresultado3.setEnabled(false);
                    // lbluch3.setVisible(false);
                }
                else{
                    lblch3.setVisible(true);
                ...
                if(r4.equals(Hepta)==false){
                    lbluch4.setVisible(true);
                    btnSiguiente.setVisible(false);
                    //cbresultado4.setEditable(false);
                    //cbresultado4.setEnabled(false);
                    // lbluch4.setVisible(false);
                }
                else{
                    lblch4.setVisible(true);
                ...
                if(r5.equals(Ovalo)==false){
                    lbluch5.setVisible(true);
                    btnSiguiente.setVisible(false);
                    //lbluch5.setVisible(true);
                    // cbresultado5.setEditable(false);
                    // cbresultado5.setEnabled(false);
                    // lbluch1.setVisible(false);
                }
                else{
                    lblch5.setVisible(true);
                ...
                if(r6.equals(Octa)==false){
                    lbluch6.setVisible(true);
                    btnSiguiente.setVisible(false);
                    //cbresultado6.setEditable(false);
                    //cbresultado6.setEnabled(false);
                    // lbluch6.setVisible(false);
                }
                else{
                    lblch6.setVisible(true);
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        String sql="UPDATE geometria SET ejercicio4 = ? WHERE nombre = '"+nom+"'";
        try{
